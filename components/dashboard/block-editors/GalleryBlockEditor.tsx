...
export default function GalleryBlockEditor({
  ...
  const addItem = (url: string) => {
    ...
    setSettings({ items: [...(s.items || []), newItem] })
    onBlurFlushSave?.()
  }
        ...
        {container.enabled !== false && (
          <>
            ...
            <SwatchRow
              ...
              onEyedropper={() => openPicker({ onPick: (hex) => setContainer({ bgColor: hex }) })}
            />
            ...
            <SwatchRow
              ...
              onEyedropper={() => openPicker({ onPick: (hex) => setContainer({ borderColor: hex }) })}
            />

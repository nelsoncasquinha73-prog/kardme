...
{/* ================== ESTILOS DO CARD ================== */}
      ...
      <Section title="🔤 Texto">
        ...
        <Row label="Tamanho do subtítulo (px)">
        ...
        <Row label="Tamanho da descrição (px)">

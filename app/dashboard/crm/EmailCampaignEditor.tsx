  ...
  return blocks.map(block => {
    ...
    switch (type) {
      ...
      case 'video':
        ...
        return content.thumbnail ? `<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin: 16px 0;"><tr><td align="${content.align || 'center'}"><a href="${videoLink}" target="_blank" style="text-decoration: none; display: inline-block;"><div style="position: relative; display: inline-block; max-width: 500px;"><img src="${content.thumbnail}" alt="Video" style="display: block; width: ${content.width || '100%'}; max-width: 500px; border-radius: 8px; margin: 0 auto;" /><div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 70px; height: 70px; background: rgba(16, 185, 129, 0.95); border-radius: 50%; display: flex; align-items: center; justify-content: center; box-shadow: 0 6px 16px rgba(16, 185, 129, 0.5); z-index: 10;"><span style="font-size: 32px; line-height: 1; color: white;">▶</span></div></div></a></td></tr></table>` : `<div style="width: 100%; height: 200px; background: #f3f4f6; border-radius: 8px; display: flex; align-items: center; justify-content: center; color: #999;">Vídeo</div>`

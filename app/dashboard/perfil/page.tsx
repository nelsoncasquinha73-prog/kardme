    ...
    <div style={{ maxWidth: 700, margin: '0 auto', padding: '20px 16px' }}>
      ...
      <div style={sectionStyle}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 20 }}>
          ...
          <div><div style={{ fontSize: 12, color: 'rgba(255,255,255,0.5)', marginBottom: 4 }}>Ciclo de faturação</div><div style={{ fontSize: 14, fontWeight: 600, color: 'rgba(255,255,255,0.9)' }}>{profile?.billing === 'yearly' ? 'Anual' : 'Mensal'}</div></div>
          <div><div style={{ fontSize: 12, color: 'rgba(255,255,255,0.5)', marginBottom: 4 }}>Renovação automática</div><div style={{ fontSize: 14, fontWeight: 600, color: 'rgba(255,255,255,0.9)' }}>{profile?.plan_auto_renew ? '✅ Ativa' : '❌ Desativada'}</div></div>
        </div>
